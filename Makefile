...
PKG_SOURCES	=  topenal.c tcapture.c tclopenal.c
PKG_OBJECTS	=  topenal.o tcapture.o tclopenal.o
...
PKG_LIB_FILE	= libopenal0.8.so
PKG_LIB_FILE8	= libopenal0.8.so
PKG_LIB_FILE9	= libtcl9openal0.8.so
PKG_STUB_LIB_FILE = libopenalstub0.8.a
...
top_builddir	= /home/danilo/Public/tclopenal
